...
const FAQ = {
  ...
  booking: {
    ...
    items: [
      ...
      { q: 'Как связаться с консьерж-службой в экстренной ситуации?', q_en: 'How to reach the concierge in an emergency?', a: 'Консьерж-служба Azanov Travel работает 24/7. WhatsApp: +66 6-3541-2949 (Тахиржан). Прямой контакт (Амин Азанов): +7 913 128-00-88. Telegram: @AzanovTravel (t.me/AzanovTravel)', a_en: 'Azanov Travel concierge is available 24/7. WhatsApp: +66 6-3541-2949. Direct: +7 913 128-00-88. Telegram: @AzanovTravel (t.me/AzanovTravel)' },
    ]
  },
};
