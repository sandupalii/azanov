/* ============================================================
   AZANOV TRAVEL — COMPONENT DATA & RENDER FUNCTIONS
   ============================================================ */
...
const PACKAGES = [
  {
    ...
    color: '#C9A84C',
    description: 'Закрытый клубный тур без массового туризма: только ваша группа, полная приватность, ощущение собственной виллы в премиум-комплексе The Regent. Идеальное сочетание wow-экскурсий на приватном катамаране, профессиональной фотосъёмки и спокойных дней полного релакса. Локация — сердце Банг Тао: 2 минуты пешком до Boat Avenue, 10 минут до пляжа и Laguna.',
  ...
  },
  {
    ...
    description: 'Минимальный тур на 5 ночей в закрытом поселке Baan Bua. Новая вилла с приватным бассейном + морской день на спидботе. Идеально для компании 6–8 человек.',
...
const expMap = {
  ...
  retreat: 'Полный тур', retreat_en: 'Full Tour',
...
const SERVICES = [
  ...
  { icon: 'ship', name: 'Аренда яхт и катеров', name_en: 'Yacht & Boat Charter', desc: 'Весь флот под ваш запрос', desc_en: 'Full fleet on request', long: 'От спидботов до суперяхт — весь флот Azanov Travel доступен под ваш маршрут. Включены трансфер до пирса, русский гид, экипаж, фрукты и напитки, снорклинг, страховка. Wi-Fi и GoPro на любой лодке.', long_en: 'From speedboats to superyachts — full Azanov Travel fleet for your route. Transfer to pier, guide, crew, fruits and drinks, snorkeling, insurance included. Wi-Fi and GoPro on every boat.' },
...
const FAQ = {
  concept: {
    ...
    items: [
      ...
      { q: 'Что входит в понятие «всё включено» для групповых туров?', q_en: 'What is included in group retreats?', a: 'Проживание на luxury-вилле, услуги личного шеф-повара, целый день на приватной яхте с обедом на борту, работа личного фотографа, все трансферы по маршруту, ежедневная уборка.', a_en: 'Luxury villa stay, personal chef, full day on private yacht with onboard lunch, personal photographer, all transfers, daily housekeeping.' },
  ...
  logistics: {
    ...
    items: [
      ...
      { q: 'Как организован трансфер из аэропорта?', q_en: 'How is airport transfer organized?', a: 'Личный трансфер включён во все пакеты Azanov Travel. Для вилл ONYX и Diamond View он включён при бронировании на сумму от $3 000. По маршруту аэропорт ↔ вилла ↔ пирс ↔ аэропорт.', a_en: 'Private transfer is included in all Azanov Travel packages. For ONYX and Diamond View villas — included for bookings from $3,000. Route: airport ↔ villa ↔ pier ↔ airport.' },
  ...
  booking: {
    ...
    labelLine2: 'рование',
    items: [
      { q: 'Включена ли медицинская страховка в пакеты?', q_en: 'Is medical insurance included in packages?', a: 'Да, медицинская страховка включена в каждый морской тур и пакетные программы Azanov Travel.', a_en: 'Yes, medical insurance is included in every sea tour and Azanov Travel package.' },
      ...
      { q: 'Как связаться с консьерж-службой в экстренной ситуации?', q_en: 'How to reach the concierge in an emergency?', a: 'Консьерж-служба Azanov Travel работает 24/7. WhatsApp: +66 6-3541-2949 (Тахиржан). Прямой контакт (Амин Азанов): +7 913 128-00-88. Telegram: @AzanovRetreat (t.me/AzanovRetreat)', a_en: 'Azanov Travel concierge is available 24/7. WhatsApp: +66 6-3541-2949. Direct: +7 913 128-00-88. Telegram: @AzanovRetreat (t.me/AzanovRetreat)' },
    ]
  },
};
...
/* ---- DATA: AZBUKA ---- */
const AZBUKA = [
  { letter: 'А', icon: 'shield-check', title: 'Авансы', short: 'Никаких скрытых платежей', long: 'В Azanov Travel мы называем цену единожды. Никаких доплат за топливо, уборку, воду, трансферы или снорклинг-маски. Полная прозрачность от первой переписки до вашего вылета.' },
  ...
  { letter: 'Я', icon: 'ship', title: 'Яхты', short: 'Лучший флот', long: 'От скоростных катеров до плавучего клуба Beach Club Yona. Наш флот — гордость Azanov Travel.' }
];

const AZBUKA_EN = [
  { letter: 'A', icon: 'shield-check', title: 'All-Inclusive', short: 'No hidden fees, ever', long: 'At Azanov Travel we name the price once. Fuel, cleaning, water, transfers, snorkeling gear — all covered from first message to your departure.' },
  ...
  { letter: 'M', icon: 'music', title: 'Music', short: "Your vibe, your soundtrack", long: "Powerful sound systems on villas and yachts, karaoke and DJ on request. Your Tour's musical backdrop is always at the highest level." },
  ...
  { letter: 'Y', icon: 'ship', title: 'Yachts', short: 'The finest fleet', long: 'From speedboats to the floating club Beach Club Yona. Our fleet is the pride of Azanov Travel.' },
