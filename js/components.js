...
const PACKAGES = [
  {
    ...
    images: villaImages('V-008', 28),
    color: '#C9A84C',
    description: 'Закрытый клубный ретрит без массового туризма: только ваша группа, полная приватность, ощущение собственной виллы в премиум-комплексе The Regent. Идеальное сочетание wow-экскурсий на приватном катамаране, профессиональной фотосъёмки и спокойных дней полного релакса.',
    description_en: 'An exclusive club retreat away from mass tourism: only your group, full privacy, the feel of your own villa in The Regent premium complex. The perfect blend of wow excursions on a private catamaran, professional photography, and calm days of full relaxation.',
    included: [
    ...
    program: [
      { day: 1, title: 'Прилёт, трансфер, welcome', title_en: 'Arrival, transfer, welcome', desc: 'Трансфер из аэропорта, welcome в апартаментах (фрукты, напитки), лёгкий ужин в Boat Avenue.', desc_en: 'Airport transfer, welcome at apartment (fruits, drinks), light dinner at Boat Avenue.' },
      { day: 2, title: 'Свободные дни релакса', title_en: 'Relaxation days', desc: 'Пляж Банг Тао, Blue Tree, Laguna, шопинг в Boat Avenue, массаж, ужины.', desc_en: 'Bang Tao beach, Blue Tree, Laguna, shopping at Boat Avenue, massage, dinners.' },
      { day: 5, title: 'Катамаран «Dolphin 50ft»', title_en: 'Catamaran «Dolphin 50ft»', desc: 'Пхи-Пхи + Майтон. Фотограф весь день.', desc_en: 'Phi Phi + Maiton. Photographer all day.' },
      { day: 6, title: 'Восстановление', title_en: 'Recovery day', desc: 'Бассейн комплекса, йога на балконе, спа, шопинг.', desc_en: 'Complex pool, balcony yoga, spa, shopping.' },
      { day: 7, title: 'Пханг Нга + Стеклянный мост', title_en: 'Phang Nga + Glass Bridge', desc: 'Полный день экскурсии. Фотограф весь день.', desc_en: 'Full-day excursion. Photographer all day.' },
      { day: 8, title: 'Hanuman World', title_en: 'Hanuman World', desc: 'Полдня зиплайн. После — релакс в апартаментах.', desc_en: 'Half-day zipline. Relax at apartment afterwards.' },
      { day: 14, title: 'Прощальный ужин', title_en: 'Farewell dinner', desc: 'Лёгкий день, возможна фотосессия на закате (доп), прощальный ужин.', desc_en: 'Easy day, optional sunset photoshoot, farewell dinner.' },
      { day: 15, title: 'Выезд', title_en: 'Departure', desc: 'Трансфер в аэропорт.', desc_en: 'Transfer to airport.' }
    ],
    extras: ['Приватный ужин шеф-поваром в апартаментах', 'Закатный круиз на яхте / катамаране', 'Премиум-спа в Anantara, Banyan Tree или Laguna', 'Дополнительные фотосессии', 'Приватный трансфер Mercedes/V Class', 'Йога/пилатес, гольф, рыбалка, дайвинг'],
    extras_en: ['Private chef dinner at apartment', 'Sunset yacht/catamaran cruise', 'Premium spa at Anantara, Banyan Tree or Laguna', 'Additional photo sessions', 'Private Mercedes/V Class transfer', 'Yoga/pilates, golf, fishing, diving'],
    sellingPoints: ['Апартаменты 140 м² в The Regent — уровень приватной виллы', 'Приватный катамаран 50 ft — стабильность, комфорт', 'Два дня профессиональной фотосъёмки', 'Баланс wow-экскурсий (3 дня) и релакса (10+ дней)', 'Локация в центре Банг Тао — всё под рукой', 'Формат закрытого клуба — только ваша группа'],
    sellingPoints_en: ['140 m² apartment at The Regent — private villa level', 'Private catamaran 50 ft — stability, comfort', 'Two days of professional photography', 'Balance of wow excursions (3 days) and relaxation (10+ days)', 'Central Bang Tao — everything at hand', 'Private club format — only your group']
  },
  {
    id: 'laguna',
...
const FLEET = [
  ...
  { id: 'f3', name: 'Madam Shadow 34ft', type: 'speedboat', guests: 6, length: '34 ft', speed: '—', price: 0, priceLabel: 'по запросу', vibe: 'Катер', vibe_en: 'Speedboat', description: 'Индивидуальная морская экскурсия на Пхукете. Профессиональный экипаж, трансфер, русский гид. Исследуйте острова Пхукета, Пханг Нга, Краби в комфорте — снорклинг, фрукты, напитки, GoPro, страховка.', description_en: 'Private speedboat for island tours around Phuket. Professional crew, transfer, Russian-speaking guide. Explore Phuket, Phang Nga, Krabi in comfort — snorkeling, fruits, drinks, GoPro, insurance.', img: 'assets/ships/motorboats/Madam Shadow 34ft/Copy of DJI_20250708145031_0001_D.jpg', images: ['assets/ships/motorboats/Madam Shadow 34ft/Copy of DJI_20250708145031_0001_D.jpg', 'assets/ships/motorboats/Madam Shadow 34ft/Copy of DJI_20250708145224_0015_D.jpg', 'assets/ships/motorboats/Madam Shadow 34ft/Copy of DJI_20250708145331_0030_D.jpg', 'assets/ships/motorboats/Madam Shadow 34ft/Copy of DJI_20250708145415_0039_D.jpg', 'assets/ships/motorboats/Madam Shadow 34ft/Copy of DJI_20250708145523_0048_D.jpg'] },
  { id: 'f4', name: 'Na-О 29ft', type: 'speedboat', guests: 6, length: '29 ft', speed: '—', price: 0, priceLabel: 'по запросу', vibe: 'Катер', vibe_en: 'Speedboat', description: 'Индивидуальная морская экскурсия на Пхукете. Профессиональный экипаж, трансфер, русский гид. Исследуйте острова Пхукета, Пханг Нга, Краби в комфорте — снорклинг, фрукты, напитки, GoPro, страховка.', description_en: 'Private speedboat for island tours around Phuket. Professional crew, transfer, Russian-speaking guide. Explore Phuket, Phang Nga, Krabi in comfort — snorkeling, fruits, drinks, GoPro, insurance.', img: 'assets/ships/motorboats/Na-О 29ft/Copy of 1D2A4907.jpg', images: ['assets/ships/motorboats/Na-О 29ft/Copy of 1D2A4907.jpg', 'assets/ships/motorboats/Na-О 29ft/Copy of 1D2A4914.jpg', 'assets/ships/motorboats/Na-О 29ft/Copy of DJI_0204.jpg', 'assets/ships/motorboats/Na-О 29ft/Copy of DJI_0229.jpg', 'assets/ships/motorboats/Na-О 29ft/Copy of DJI_0308.jpg'] },
  { id: 'f5', name: 'Nanea 40ft', type: 'speedboat', guests: 8, length: '40 ft', speed: '—', price: 0, priceLabel: 'по запросу', vibe: 'Катер', vibe_en: 'Speedboat', description: 'Индивидуальная морская экскурсия на Пхукете. Профессиональный экипаж, трансфер, русский гид. Исследуйте острова Пхукета, Пханг Нга, Краби в комфорте — снорклинг, фрукты, напитки, GoPro, страховка.', description_en: 'Private speedboat for island tours around Phuket. Professional crew, transfer, Russian-speaking guide. Explore Phuket, Phang Nga, Krabi in comfort — snorkeling, fruits, drinks, GoPro, insurance.', img: 'assets/ships/motorboats/Nanea 40ft/Copy of DJI_20240405170844_0106_D.jpg', images: ['assets/ships/motorboats/Nanea 40ft/Copy of DJI_20240405170844_0106_D.jpg', 'assets/ships/motorboats/Nanea 40ft/Copy of DJI_20240405170856_0107_D.jpg', 'assets/ships/motorboats/Nanea 40ft/Copy of DJI_20240405170925_0109_D.jpg', 'assets/ships/motorboats/Nanea 40ft/Copy of DJI_20240405170939_0110_D.jpg', 'assets/ships/motorboats/Nanea 40ft/Copy of DJI_20240405171009_0114_D.jpg'] },
  ...
  { id: 'f8', name: 'Sabi 375', type: 'speedboat', guests: 8, length: '—', speed: '—', price: 0, priceLabel: 'по запросу', vibe: 'Катер', vibe_en: 'Speedboat', description: 'Индивидуальная морская экскурсия на Пхукете. Профессиональный экипаж, трансфер, русский гид. Исследуйте острова Пхукета, Пханг Нга, Краби в комфорте — снорклинг, фрукты, напитки, GoPro, страховка.', description_en: 'Private speedboat for island tours around Phuket. Professional crew, transfer, Russian-speaking guide. Explore Phuket, Phang Nga, Krabi in comfort — snorkeling, fruits, drinks, GoPro, insurance.', img: 'assets/ships/motorboats/Sabi 375/SABI-Raptor-38-1.jpg', images: ['assets/ships/motorboats/Sabi 375/SABI-Raptor-38-1.jpg', 'assets/ships/motorboats/Sabi 375/SABI-Raptor-38-2.jpg', 'assets/ships/motorboats/Sabi 375/SABI-Raptor-38-3.jpg', 'assets/ships/motorboats/Sabi 375/SABI-Raptor-38-4.jpg', 'assets/ships/motorboats/Sabi 375/SABI-RAPTOR-38-5.jpg'] },
  { id: 'f35', name: 'Beach Club Yona', type: 'superyacht', guests: 300, length: '—', speed: '7 кн', price: 2000000, priceLabel: 'от 2 000 000 ฿', vibe: 'Суперяхта', vibe_en: 'Superyacht', description: 'Суперяхта Beach Club Yona — эксклюзивный плавучий клуб. Бассейн, зоны отдыха, DJ. Идеальна для премиум-мероприятий и вечеринок.', description_en: 'Superyacht Beach Club Yona — exclusive floating club. Pool, lounges, DJ. Ideal for premium events and parties.', img: 'assets/ships/motor-yachts/Beach Club Yona/Yona beach club 2.jpg', images: ['assets/ships/motor-yachts/Beach Club Yona/Yona beach club 2.jpg', 'assets/ships/motor-yachts/Beach Club Yona/Yona Beach club pool bed.jpg', 'assets/ships/motor-yachts/Beach Club Yona/Yona beach club sea bed.jpg', 'assets/ships/motor-yachts/Beach Club Yona/Yona bed and cabana.jpg', 'assets/ships/motor-yachts/Beach Club Yona/Yona Dj booth.jpg'] },
  ...
  { id: 'f71', name: 'Yamela 15', type: 'speedboat', guests: 10, length: '—', speed: '30 кн', price: 12990, priceLabel: 'от 12 990 ฿', vibe: 'Катер', vibe_en: 'Speedboat', description: 'Спидбот для индивидуальных морских экскурсий на Пхукете. Идеален для компании друзей или семьи. За несколько часов можно посетить несколько островов — от Кораллового до Пхи-Пхи.', description_en: 'Private speedboat for island tours around Phuket. Professional crew, transfer, Russian-speaking guide. Explore Phuket, Phang Nga, Krabi in comfort — snorkeling, fruits, drinks, GoPro, insurance.', img: 'assets/ships/motorboats/Yamela 15/DJI_0006.jpg', images: ['assets/ships/motorboats/Yamela 15/DJI_0006.jpg', 'assets/ships/motorboats/Yamela 15/DJI_0024h.jpg', 'assets/ships/motorboats/Yamela 15/DJI_0029e.jpg', 'assets/ships/motorboats/Yamela 15/DJI_0033h.jpg', 'assets/ships/motorboats/Yamela 15/DJI_0033hh.jpg'] },
  ...
  { id: 'f66', name: 'Cobalt Zoom 37ft', type: 'speedboat', guests: 6, length: '37 ft', speed: '—', price: 0, priceLabel: 'по запросу', vibe: 'Катер', vibe_en: 'Speedboat', description: 'Индивидуальная морская экскурсия на Пхукете. Профессиональный экипаж, трансфер, русский гид. Исследуйте острова Пхукета, Пханг Нга, Краби в комфорте — снорклинг, фрукты, напитки, GoPro, страховка.', description_en: 'Private speedboat for island tours around Phuket. Professional crew, transfer, Russian-speaking guide. Explore Phuket, Phang Nga, Krabi in comfort — snorkeling, fruits, drinks, GoPro, insurance.', img: 'assets/ships/motorboats/Cobalt Zoom 37ft/0234.jpg', images: ['assets/ships/motorboats/Cobalt Zoom 37ft/0234.jpg', 'assets/ships/motorboats/Cobalt Zoom 37ft/Copy of DJI_20250325163237_0002_D-Enhanced-NR.jpg', 'assets/ships/motorboats/Cobalt Zoom 37ft/Copy of DJI_20250325163242_0003_D-Enhanced-NR-2.jpg', 'assets/ships/motorboats/Cobalt Zoom 37ft/Copy of DJI_20250325163242_0003_D.jpg', 'assets/ships/motorboats/Cobalt Zoom 37ft/Copy of DJI_20250325163250_0004_D-Enhanced-NR.jpg'] },
  ...
  { id: 'f12', name: 'Shaina 55ft', type: 'motorboat', guests: 22, length: '55 ft', speed: '—', price: 0, priceLabel: 'по запросу', vibe: 'Рыбацкая лодка', vibe_en: 'Fishing Boat', description: 'Индивидуальная морская экскурсия на Пхукете. Профессиональный экипаж, трансфер, русский гид. Исследуйте острова Пхукета, Пханг Нга, Краби в комфорте — снорклинг, фрукты, напитки, GoPro, страховка.', description_en: 'Fishing charter in Phuket. Professional crew, all fishing equipment provided. Half-day and full-day options.', img: 'assets/ships/fishing-boats/Shaina 55ft/DJI_0041.jpg', images: ['assets/ships/fishing-boats/Shaina 55ft/DJI_0041.jpg', 'assets/ships/fishing-boats/Shaina 55ft/DJI_0043.jpg', 'assets/ships/fishing-boats/Shaina 55ft/DJI_0044.jpg', 'assets/ships/fishing-boats/Shaina 55ft/DJI_0047.jpg', 'assets/ships/fishing-boats/Shaina 55ft/DJI_0051.jpg'] },
...
async function openItemModal(type, id) {
  ...
  if (type === 'package') {
    ...
    const includedList = includedFiltered.slice(0, 8);
    const moreCount = includedFiltered.length - 8;
    ...
    const programList = (item.program || []).slice(0, 8);
    const programMore = (item.program || []).length - 8;
    const sellingList = (item.sellingPoints || []).slice(0, 6);
    const extrasList = (item.extras || []).slice(0, 6);
    const extrasMore = (item.extras || []).length - 6;
    const panelIncluded = `
    ...
    const sellingListEn = (item.sellingPoints_en || []).slice(0, 6);
    ...
    ` : `<div class="muted" style="font-size:0.8rem">—</div>`;
    const extrasListEn = (item.extras_en || []).slice(0, 6);
    ...
    const desc = rawDesc.length > 220 ? rawDesc.slice(0, 217) + '…' : rawDesc;
    infoHTML = `
      ...
      ${desc ? `<p class="body-sm muted" style="font-size:0.8rem;line-height:1.4;margin-bottom:0.75rem">${desc}</p>` : ''}
